...
Obrigado por contribuir com **CRO + GEO Audit Toolkit**. Este repositório contém uma Agent Skill; mudanças aqui alteram como agentes se comportam, tomam decisões, consultam contexto e pedem consentimento ao usuário.
